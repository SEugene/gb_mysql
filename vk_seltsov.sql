...
CREATE TABLE `preferences` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL,
  `preferences_type_id` int unsigned NOT NULL,
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `preferences_type_id` (`preferences_type_id`),
  CONSTRAINT `preferences_ibfk_1` FOREIGN KEY (`preferences_type_id`) REFERENCES `preferences_types` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `preferences_types` (
  ...
  UNIQUE KEY `id` (`id`),
  KEY `pref_types_idx` (`type_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `preferences_types`
--

LOCK TABLES `preferences_types` WRITE;
...
CREATE TABLE `profiles` (
  ...
  KEY `fk_pref` (`pref_id`),
  KEY `fk_fp` (`fp_id`),
  CONSTRAINT `fk_fp` FOREIGN KEY (`fp_id`) REFERENCES `favorite_places` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_pref` FOREIGN KEY (`pref_id`) REFERENCES `preferences` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='юзеры';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-06-04  9:47:53
